/* Modernizr 2.8.2 (Custom Build) | MIT & BSD Build:
 * http://modernizr.com/download/#-video-cssclasses
 */;
window.Modernizr = function (a, b, c) {
    ...
    for (var z in m) 
        t(m, z) && (r = z.toLowerCase(), e[r] = m[z](), p.push((
            e[r]
                ? ""
                : "no-"
        ) + r));
    return e.addTest = function (a, b) {
        if (typeof a == "object") 
            ...
            b = typeof b == "function"
                ? b()
                : b,
            typeof f != "undefined" && f && (g.className += " " + (
                b
                    ? ""
                    : "no-"
            ) + a),
